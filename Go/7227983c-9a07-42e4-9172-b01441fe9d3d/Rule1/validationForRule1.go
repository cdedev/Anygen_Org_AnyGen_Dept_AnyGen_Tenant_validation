...
import (
	...
	"strconv"
	"strings"
	parser "Anygen_Org_AnyGen_Dept_AnyGen_Tenant_validation/Go/7227983c-9a07-42e4-9172-b01441fe9d3d/Rule1/parser"
...
expression :  field1 field2 field3 field4 field5 EOF ;
...
FIELD1 :SPLITKEY  OWNKEY [0-9]* ;

FIELD2 :SPLITKEY  OWNKEY OWNKEY [0-9A-Za-z ]* ;

FIELD3 :SPLITKEY  OWNKEY OWNKEY OWNKEY [A-Za-z .]* ;

FIELD4 :SPLITKEY  OWNKEY OWNKEY OWNKEY OWNKEY [0-9.]* ;

FIELD5 :SPLITKEY  OWNKEY OWNKEY OWNKEY OWNKEY OWNKEY [0-9A-Za-z .]* ;
