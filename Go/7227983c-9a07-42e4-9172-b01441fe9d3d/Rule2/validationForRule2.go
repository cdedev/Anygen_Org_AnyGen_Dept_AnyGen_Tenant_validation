...
import (
	...
	"strconv"
	"strings"
	parser "Anygen_Org_AnyGen_Dept_AnyGen_Tenant_validation/Go/7227983c-9a07-42e4-9172-b01441fe9d3d/Rule2/parser"
...
expression :  field0 field1 field2 EOF ;
...
FIELD1 :SPLITKEY  OWNKEY OWNKEY [0-9.,*/]* ;

FIELD2 :SPLITKEY  OWNKEY OWNKEY OWNKEY [0-9]* ;
