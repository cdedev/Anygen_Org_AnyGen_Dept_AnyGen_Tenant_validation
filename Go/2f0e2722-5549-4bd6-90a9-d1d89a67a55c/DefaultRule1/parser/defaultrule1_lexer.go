...
var defaultrule1lexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func defaultrule1lexerLexerInit() {
	staticData := &defaultrule1lexerLexerStaticData
...
// DefaultRule1LexerInit initializes any static state used to implement DefaultRule1Lexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDefaultRule1Lexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DefaultRule1LexerInit() {
	staticData := &defaultrule1lexerLexerStaticData
	staticData.once.Do(defaultrule1lexerLexerInit)
}

// NewDefaultRule1Lexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDefaultRule1Lexer(input antlr.CharStream) *DefaultRule1Lexer {
	DefaultRule1LexerInit()
