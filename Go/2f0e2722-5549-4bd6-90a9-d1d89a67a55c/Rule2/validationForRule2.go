...
import (
	...
	"strconv"
	"strings"
	parser "Anygen_Org_AnyGen_Dept_AnyGen_Tenant_validation/Go/2f0e2722-5549-4bd6-90a9-d1d89a67a55c/Rule2/parser"
...
expression :  questions EOF ;

questions : QUESTIONS ;

QUESTIONS :SPLITKEY  OWNKEY [0-9A-Za-z .]* ;
